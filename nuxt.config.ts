  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:title', content: 'GoldenPassport - Define Your Own Digital "Fingerprint"!' },
        ...
        { property: 'og:image', content: 'https://goldenpassport.com/logo-gold.png' },
        { property: 'og:image:secure_url', content: 'https://goldenpassport.com/logo-gold.png' },
        ...
        { name: 'twitter:title', content: 'GoldenPassport - Define Your Own Digital "Fingerprint"!' },
        { name: 'twitter:description', content: 'Privacy-focused online identity management. Control your data, protect from profiling.' },
        { name: 'twitter:image', content: 'https://goldenpassport.com/logo-gold.png' },
